...
class ConnectWithMusicCulture extends React.Component {
  render(){
  return (
...
export class IconContentMusic extends React.Component {
  render(){
    return (
  ...
  export class IconContentMusic2 extends React.Component{
    render(){
    return (
      <div style={{padding:"2%",cursor: 'pointer'}}><div>
  ...
  export class IconContentMusic3 extends React.Component {
    render(){
    return (
      <div style={{padding:"2%",cursor: 'pointer'}}><div>
  ...
  export class IconContentMusic4 extends React.Component {
    render(){
    return (
      <div style={{padding:"2%",cursor: 'pointer'}}><div>
